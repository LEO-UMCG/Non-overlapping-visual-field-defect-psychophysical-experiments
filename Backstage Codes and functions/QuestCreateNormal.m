function q=QuestCreateNormal(tGuess,tGuessSd,pThreshold,beta,delta,gamma,grain,range,plotIt)
...
if nargin < 6 || nargin > 9
	error('Usage: q=QuestCreateNormal(tGuess,tGuessSd,pThreshold,beta,delta,gamma,[grain],[range])')
end
...
q.grain=grain;
q.dim=dim;
q=QuestRecomputeNormal(q, plotIt);
