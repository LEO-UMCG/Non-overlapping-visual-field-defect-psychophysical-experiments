function DrawFrame_filled_circle(w, xCenter, yCenter, xOffset, yOffset, stimRect,R0, noiseTex)
    ...
    Screen('FillRect', w, [R0 R0 R0 1], [stimRectLeft(1)+25 stimRectLeft(2)+25 stimRectLeft(3)-25 stimRectLeft(4)-25])
    ...
    Screen('FillRect', w, [R0 R0 R0 1], [stimRectRight(1)+25 stimRectRight(2)+25 stimRectRight(3)-25 stimRectRight(4)-25])
